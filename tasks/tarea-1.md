...
R: Es el ejecutable de python que importa a Flask para que pueda hostear al index
2. ¿Por que necesitas el entorno virtual (.venv)?
R: Es el entorno que permite que flask exista de manera local
...
R: No se verá porque flask está conectado al proyecto que está en mi maquina local
5. ¿Que es render_template y por que Flask lo usa?
R: Es el comando que renderiza mi página web.
