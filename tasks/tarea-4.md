...
R: En html solo debo de definir el bucle para que se renderizen desde el archivo de python
2. ¿Que pasa si accedes a una propiedad que no existe, como `{{ tarea.profesor }}`?
R: No aparecerá nada en index ya que flask no encuentra esta propiedad y afecta en el funcionamiento
del archivo python
3. ¿Como cambarias el bucle si quisieras mostrar solo las primeras 5 tareas?
R: Realmente no estoy seguro pero pondria un limite con un mayor o igual a 5 en numero.
