...
R: Bootstrap tiene hechos diferentes codigos para hacer tu sitio profesional, en cambio haciendolo manualmente eres más propenso a fracasar por no ser lo suficientemente profesional
2. ¿Como ayuda template herencia a mantener el codigo limpio?
R: Evita repetir código
3. ¿Que otras mejoras visuales podrias hacer?
R: Luces, y texto más llamantivo entre otros
