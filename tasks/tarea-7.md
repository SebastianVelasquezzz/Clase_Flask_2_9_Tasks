...
R: Porque al estar en texto plano no está encriptado, cualquiera que sepa de programación puede ver la contraseña
2. ¿Que diferencia hay entre crear un Usuario y loguear?
R: Al crear registras un nuevo usuario en la página, al loguear entras en una cuenta creada previamente
3. ¿Como protegeria la ruta `/estudiantes` para que solo profesor pueda verla?
R: Limitaria el acceso para que solo el profesor logueado pueda verla
