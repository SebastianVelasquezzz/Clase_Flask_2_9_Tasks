...
R: Que los datos de python son editables de forma automatica solo cambiando el contenido de la 
variable, no del index manualmente
2. Si el profesor cambia mañana, ¿cuantos archivos necesitas editar con este enfoque?
R: Solo las variables que tengan informacion del profesor
3. ¿Que ventaja tiene usar `{{ }}` en lugar de escribir texto fijo?
R: Que llamas a la variable previamente escrita en python
4. ¿Donde se ejecuta Jinja2: en la computadora del usuario o en el servidor?
R: Jinja se ejecuta en la computadora del usuario 
