...
R: Una crea, otra lee, actualiza y la ultima borra, imagino que son datos de variables pero estas son las principales diferencias
2. ¿Por que es importante tener ForeignKey entre Tarea y Usuario?
R: Para tener asignada la tarea a su respectivo estudainte
3. ¿Como protegearias la ruta de crear tarea para que solo profesor pueda?
R: Limitaria el acceso con la cuenta creada
