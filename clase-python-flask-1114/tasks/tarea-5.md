...
R: El email tiene un condicional que obliga al usuario a poner un @ y terminar con un dominio .com, etc.
2. ¿Que hace el atributo `required` en un campo?
R: Especifica que está requerido para poder continuar con el funcionamiento del campo
3. Si un usuario completa el formulario, ¿donde se guardan esos datos ahora?
R: Por ahora se guardan en una variable llamada mensaje que no es llamda en otro .html
